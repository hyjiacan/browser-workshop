    ...
    '/en/guide/': [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Local Installation', link: '/en/guide/import' },
...
export default defineConfig({
  ...
  locales: {
    ...
    en: {
      ...
      link: '/en/',
      title: 'Browser Workshop',
      description: 'Multi-version browser management tool supporting local installation, remote download, version switching, and isolated execution.',
